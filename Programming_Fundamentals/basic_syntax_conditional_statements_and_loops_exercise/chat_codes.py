...
# Create a program that receives the n number of messages sent. On the following n lines, it will receive integer numbers. F
# or each number, the program should print a different message:
